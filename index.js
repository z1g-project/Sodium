...
function startServer() { 
  ...
  console.log("⚠️WARNING: You are using a experimental build of Sodium that is not publicaly released yet if you enounter any bugs please report them to our github/discord and hope you enjoy!")

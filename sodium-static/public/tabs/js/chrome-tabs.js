;((window, factory) => {
    ...
    class ChromeTabs {
        ...
        get tabContentWidths() {
            ...
            const numberOfTabsMath =
                numberOfNonPinnedTabs + numberOfPinTabs * 0.137
                ...
                function (c) {
                    ...
                    if (
                        ...
                        document
                            ...
                            .setAttribute(
                                'onclick',
                                "toggleId('ctx');chromeTabs.unpinTab(ctxTab);",
                            )
                    } else {
                        ...
                        document
                            ...
                            .setAttribute(
                                'onclick',
                                "toggleId('ctx');chromeTabs.pinTab(ctxTab);",
                            )
                    }
                    openMenu('ctx')
                    c.preventDefault()
        ...
        removeTab(tabEl) {
            if (tabEl === this.activeTabEl) {
                if (tabEl.nextElementSibling) {
                    let tempval =
                        +tabEl.nextElementSibling.getAttribute('ifd') + 1
                    document.getElementById(tempval).style =
                        'display:inlinebackground: #FFFFFF'
                    this.setCurrentTab(tabEl.nextElementSibling)
                } else if (tabEl.previousElementSibling) {
                    let tempval =
                        +tabEl.previousElementSibling.getAttribute('ifd') + 1
                    document.getElementById(tempval).style =
                        'display:inlinebackground: #FFFFFF'
        ...
        pinTab(tabId) {
            ...
            if (!localStorage.getItem('ctPins')) {
                ...
                pins[Object.keys(pins).length + 1] = {
                    url: frmEl.contentDocument.URL,
                }
        ...
        setupDraggabilly() {
            ...
            if (this.isDragging) {
                ...
                this.hypertabContainer.classList.remove(
                    'chrome-tabs-is-sorting',
                )
            ...
            tabEls.forEach((tabEl, originalIndex) => {
                ...
                draggabilly.on('dragStart', (_) => {
                    ...
                    this.hypertabContainer.classList.add(
                        'chrome-tabs-is-sorting',
                    )
                })

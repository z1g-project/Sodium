;(function () {
    function loadSavedSettings() {
        ...
        if (useRandomize) {
            ...
            const favicons = [
                ...
                'https://cdn.z1g-project.pages.dev/',
                'https://www.microsoft.com/favicon.ico',
                'https://ssl.gstatic.com/images/branding/product/1x/drive_2020q4_32dp.png',
                'https://kahoot.it/favicon.ico',
                'https://www.outlook.com/owa/favicon.ico',
            ]
            const randomTitleIndex = Math.floor(Math.random() * titles.length)
            const randomFaviconIndex = Math.floor(
                Math.random() * favicons.length,
            )
        ...
        if (
            ...
            if (searchEngineSelect) {
                ...
                if (searchEngine === 'custom') {
                    const customSearchEngineInput = document.getElementById(
            ...
            const bareServerInput = document.getElementById(
                'custom-bare-server-input',
            )
            if (bareServerInput) {
            ...
            const emergencyHotkeyInput = document.getElementById(
                'emergency-switch-hotkey',
            )
            ...
            if (emergencyHotkeyInput) {
                emergencyHotkeyInput.addEventListener(
                    'click',
                    function (event) {
            ...
            const emergencyURLInput = document.getElementById(
                'emergency-url-input',
            )
            ...
            const fallbackUrlInput =
                document.getElementById('fallback-url-input')
        ...
        const use24HourTimeCheckbox = document.getElementById(
            'use-24hour-checkbox',
        )
        ...
        const includeDateCheckbox = document.getElementById(
        ...
        const useSecondsCheckbox = document.getElementById(
            'use-seconds-checkbox',
        )
        ...
        if (window.location.pathname.includes('/settings/')) {
            ...
            if (metaThemeColor) {
                document.getElementById('meta-theme-color').value =
                    metaThemeColor
    ...
    function saveSettings() {
        ...
        if (searchEngine === 'custom') {
            const customSearchUrl = document
                .getElementById('custom-search-engine-input')
                .value.trim()
        ...
        var selectedOption =
            proxySelect.options[proxySelect.selectedIndex].value
        ...
        if (emergencyHotkeyInput) {
            const emergencyHotkey = emergencyHotkeyInput.value
                .trim()
                .toLowerCase()
                        ...
                        for (const registration of registrations) {
                            if (
                                ...
                                registration.unregister().then(() => {
                                    ...
                                    console.log(
                                        'Dynamic service worker re-registered.',
                                    )
                                })
                            }
                        }
        ...
        if (use24HourTimeCheckbox) {
            localStorage.setItem(
                'use24HourTime',
                use24HourTimeCheckbox.checked.toString(),
            )
            console.log(
                'Use 24 Hour Time Saved:',
                use24HourTimeCheckbox.checked,
            )
        }
        ...
        if (includeDateCheckbox) {
            localStorage.setItem(
                'showDate',
                includeDateCheckbox.checked.toString(),
            )
        ...
        if (useSecondsCheckbox) {
            ...
            console.log(
                'Include Seconds in TimeBar:',
                useSecondsCheckbox.checked,
            )
        }

        ...
        var _e = {
            ...
            relative: function (t, i) {
                if (
                    ...
                    te(i),
                    t === i ||
                        ((t = _e.resolve(t)), (i = _e.resolve(i)), t === i))
                )
                    return ''
        ...
        get(e, t, i) {
            if (e instanceof IDBTransaction) {
                ...
                if (t === 'objectStoreNames')
                    return e.objectStoreNames || Er.get(e)
                if (t === 'store')
...
`,
    ...
    w.isAsyncFunction = function () {
        ...
        return (
            ...
            (t + 8 === this.input.length ||
                !(
                    be((i = this.input.charCodeAt(t + 8))) ||
                    (i > 55295 && i < 56320)
                ))
        )
    }
    ...
    w.parseFunction = function (e, t, i, r, n) {
        this.initFunction(e),
            ...
            t & Pe &&
                ((e.id =
                    t & Wr && this.type !== u.name ? null : this.parseIdent()),
                e.id &&
                    !(t & qt) &&
        ...
        return (
            ...
            this.finishNode(
                e,
                t & Pe ? 'FunctionDeclaration' : 'FunctionExpression',
            )
        )
    }
    ...
    w.parseClassStaticBlock = function (e) {
        ...
        var t = this.labels
        for (
            this.labels = [], this.enterScope(Ne | Kt);
            this.type !== u.braceR;
...
`,
    ...
    C.readRegexp = function () {
        for (var e, t, i = this.pos; ; ) {
            ...
            if (
                (Y.test(r) && this.raise(i, 'Unterminated regular expression'),
                e)
            )
                e = !1
            else {
        ...
        $s = {
            ...
            BlockStatement: (Rn = function (e, t) {
                ...
                if (s != null && s.length > 0) {
                    t.write(r),
                        n && e.comments != null && j(t, e.comments, a, r)
                    let { length: o } = s
                    for (let c = 0; c < o; c++) {
                        let l = s[c]
...
`)
    ...
    var lo = {
        ...
        po = {
            encode: (e) =>
                e && encodeURIComponent(ia(e, 'dynamic').substring(10)),
            decode: (e) =>
                e && ra('U2FsdGVkX1' + decodeURIComponent(e), 'dynamic'),
        },

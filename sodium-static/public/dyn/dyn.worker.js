...
;(() => {
        ...
        var be = {
            ...
            relative: function (t, i) {
                ...
                for (
                    ...
                    if (y === l) {
                        if (c > l) {
                            if (i.charCodeAt(n + y) === 47)
                                return i.slice(n + y + 1)
    ...
    var Xr = St((Xn, Ve) => {
        ...
        function Yr(e, t) {
            if (((t = t ? Object.assign({}, Se, t) : Se), !e))
                return t.map ? {} : []
            if (e.headers)
        ...
        function un(e) {
            ...
            for (; i < e.length; ) {
                for (r = i, u = !1; c(); )
                    if (((s = e.charAt(i)), s === ',')) {
                        for (a = i, i += 1, c(), n = i; i < e.length && l(); )
                            i += 1
        ...
        get(e, t, i) {
            if (e instanceof IDBTransaction) {
                ...
                if (t === 'objectStoreNames')
                    return e.objectStoreNames || Ji.get(e)
                if (t === 'store')
    ...
    var ta = [
        ...
        ar = [
            ...
            42719, 33, 4153, 7, 221, 3, 5761, 15, 7472, 3104, 541, 1507, 4938,
            6, 4191,
        ],
        ia =
...
`,
    ...
    w.isAsyncFunction = function () {
        ...
        return (
            ...
            (t + 8 === this.input.length ||
                !(
                    ve((i = this.input.charCodeAt(t + 8))) ||
                    (i > 55295 && i < 56320)
                ))
        )
    }
    ...
    w.parseFunction = function (e, t, i, r, s) {
        this.initFunction(e),
            ...
            t & Re &&
                ((e.id =
                    t & yr && this.type !== o.name ? null : this.parseIdent()),
                e.id &&
                    !(t & Vt) &&
    ...
    w.parseClassStaticBlock = function (e) {
        ...
        var t = this.labels
        for (
            this.labels = [], this.enterScope(De | Ft);
            this.type !== o.braceR;
    ...
    w.parseClassId = function (e, t) {
        this.type === o.name
            ? ((e.id = this.parseIdent()),
              t && this.checkLValSimple(e.id, le, !1))
        ...
        for (
            ...
            if (
                ...
                if (n) {
                    ...
                    ;(c.expression = u),
                        (u = this.finishNode(c, 'ChainExpression'))
                }
                return u
            }
            e = u
...
`,
    ...
    v.regexp_eatUnicodePropertyValueExpression = function (e) {
        ...
        if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
            ...
            if (this.regexp_eatUnicodePropertyValue(e)) {
                ...
                return (
                    this.regexp_validateUnicodePropertyNameAndValue(e, i, r), ue
                )
            }
        }
    ...
    var Gt = function (t) {
            ;(this.type = t.type),
                ...
                (this.end = t.end),
                t.options.locations &&
                    (this.loc = new at(t, t.startLoc, t.endLoc)),
    ...
    E.readRegexp = function () {
        for (var e, t, i = this.pos; ; ) {
            ...
            if (
                (Z.test(r) && this.raise(i, 'Unterminated regular expression'),
                e)
            )
                e = !1
            else {
        ...
        dn = {
            ...
            BlockStatement: (rs = function (e, t) {
                ...
                if (n != null && n.length > 0) {
                    t.write(r),
                        s && e.comments != null && H(t, e.comments, a, r)
                    let { length: u } = n
                    for (let c = 0; c < u; c++) {
                        let l = n[c]
...
self.document?.currentScript?.remove();`,
        ...
        if (e.match(this.ctx.regex.DataRegex)) {
            try {
                ...
                if (i) {
                    var [r, s, a, n, u] = i
                    n == 'base64'
                        ? (u = this.ctx.modules.base64.atob(
    ...
    var En = function (e) {
            var t = [],
                i
            for (i = 0; i < e; i++)
                t = t.concat(Math.floor(Math.random() * 256))
            return t
        },
        Ss = function (e, t) {
            var i = ye >= 12 ? 3 : 2,
        ...
        ji = function (e, t) {
            var i,
                r = []
            for (i = 0; i < e.length; i += t)
                r[i / t] = parseInt(e.substr(i, t), 16)
            return r
        },
        Ln = function (e) {
            var t,
...
`)
    ...
    var Bn = {
        ...
        Mn = {
            encode: (e) =>
                e && encodeURIComponent(Ps(e, 'dynamic').substring(10)),
            decode: (e) =>
                e && Rs('U2FsdGVkX1' + decodeURIComponent(e), 'dynamic'),
        },
                    ...
                    try {
                        ...
                        if (
                            ...
                            return (
                                c.meta.load(
                                    new URL(
                                        p.headers.get('x-dynamic-location'),
                                    ),
                                ),
                                c.is.html(
                                    c.meta,
                                    ...
                                    ? (a = new Blob([
                                          c.rewrite.html.rewrite(m, c.meta, b),
                                      ]))
                                    : (a = g),
                                new Response(a, {
                                    status: p.status,
                        ...
                        t.headers.method.body.indexOf(s.method.toUpperCase()) ==
                            -1 && (x.body = await s.blob()),
                            c.meta.protocol !== 'about:'
                                ? (f = await (
                                      await t.bare
                                  ).fetch(c.meta.href, x.init))
                                : (f = new t.util.about(
                                      new Blob([
                        ...
                        R == !1 && (R = await f.blob()),
                            t.headers.status.empty.indexOf(f.status) !== -1 &&
                                (R = null),

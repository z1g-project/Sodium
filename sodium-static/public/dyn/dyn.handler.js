        ...
        get(e, t, i) {
            if (e instanceof IDBTransaction) {
                ...
                if (t === 'objectStoreNames')
                    return e.objectStoreNames || Sr.get(e)
                if (t === 'store')
...
`,
    ...
    w.parseFunction = function (e, t, i, r, n) {
        this.initFunction(e),
            ...
            t & Re &&
                ((e.id =
                    t & Hr && this.type !== u.name ? null : this.parseIdent()),
                e.id &&
                    !(t & Gt) &&
    ...
    w.parseClassStaticBlock = function (e) {
        ...
        var t = this.labels
        for (
            this.labels = [], this.enterScope(Me | Xt);
            this.type !== u.braceR;
...
`,
    ...
    var ei = function (t) {
            ;(this.type = t.type),
                ...
                (this.end = t.end),
                t.options.locations &&
                    (this.loc = new st(t, t.startLoc, t.endLoc)),
...
`)
    ...
    var lo = {
        ...
        po = {
            encode: (e) =>
                e && encodeURIComponent(ta(e, 'dynamic').substring(10)),
            decode: (e) =>
                e && ia('U2FsdGVkX1' + decodeURIComponent(e), 'dynamic'),
        },

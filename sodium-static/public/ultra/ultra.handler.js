;(() => {
    ...
    self.__uvHook = p
    function p(o) {
        if ('__uv' in o && o.__uv instanceof f) return !1
        o.document &&
            o.window &&
            o.document
                ...
                e.cookie.db().then((l) => {
                    e.cookie.setCookies(t.data.value, l, e.meta),
                        e.cookie.getCookies(l).then((i) => {
                            n = e.cookie.serialize(i, e.meta, !0)
                        })
                })
        ...
        let A =
            u &&
            Object.getOwnPropertyDescriptor(u.prototype, 'contentWindow').get
        function U(t) {
            let r = A.call(t)
            if (!r.__uv)
                try {
            ...
            for (let t of a.style.urlProps)
                a.overrideDescriptor(o.CSS2Properties.prototype, t, {
                    ...
                    set: (r, l, i) => {
                        r.call(
                            l,
                            e.rewriteCSS(i, { context: 'value', ...e.meta }),
                        )
                    },
                })
        else
        ...
        a.style.on('setCssText', (t) => {
            ...
            a.override(o, 'open', (t, r, l) => {
                ...
                let [i] = l
                return (i = e.rewriteUrl(i)), t.call(r, i)
            }),
            (e.$wrap = function (t) {
                return t === 'location'
                    ? e.methods.location
            ...
            (e.eval = a.wrap(o, 'eval', (t, r, l) => {
                ...
                let [i] = l
                return (i = e.rewriteJS(i)), t.call(r, i)
            })),

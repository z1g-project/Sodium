const addons = [
    {
        ...
        category: 'plugins',
        description:
            'School Blocked Tampermonkey? No Sweat use DuoPower on Sodium!',
    ...
    },
    {
        ...
        publisher: '✅ Sodium Addons',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/eruda.js',
    },
    {
        name: 'DarkMode',
        category: 'plugins',
        ...
        publisher: '✅ Sodium Addons',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/darkmode.js',
    },
    {
        ...
        publisher: 'MDCM',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/yt.js',
    },
    {
        name: 'Bing AI',
        category: 'plugins',
        ...
        publisher: 'avd3',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/bingai.js',
    },
    {
        name: 'Weird Theme',
        category: 'themes',
    ...
    },
    {
        ...
        publisher: 'r8d8',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/gmailremove.js',
    },
    {
        name: 'AdBlocker',
        category: 'plugins',
        ...
        publisher: '✅ Sodium Addons',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/adblock.js',
    },
    {
        name: 'Paper.io ZOOM HACK - Paperio Hacks',
        category: 'plugins',
        description:
            'Paperio Mods Features: Zoom Hack, Unlock All Skins, Change Everything, Auto Turn Bot, FPS paper-io.com',
        publisher: 'GameHackerC',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/paperio.js',
    },
    {
        ...
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/linkvert.js',
    },
    {
        ...
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/spotify.js',
    },
    {
        ...
        publisher: '@Masiosare',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/tiktok.js',
    },
    {
        name: 'GPTSearch',
        category: 'plugins',
    ...
    },
    {
        ...
        publisher: 'ww',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/powerlineio.js',
    },
    {
        ...
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/quizlet.js',
    },
    {
        name: 'Aternos Minecraft Server Hosting ADBLOCKER',
        category: 'plugins',
        description:
            'Great minecraft hosting, but it has adblocker detection, this script automatically destroy antiadblock windows. I would prefer to show a donate button instead of forcing Ads.',
        publisher: 'Lukáš Kovář',
        url: 'https://cdn.z1g-project.pages.dev/sodium/plugins/aternos.js',
    },
    {
        name: 'Yohoho.io Cheats',
        category: 'plugins',
        description:
            'Cheats for the popular IO game, Yohoho.IO! Press p to change your pet. l to change the pets level, x to change your xp, i to change your island, c to change your character, and o to change your coins.',
        publisher: 'Steviegt6',
        ...
        button.addEventListener('click', () => {
            ...
            if (addonType === 'themes') {
                ...
                notification.textContent =
                    'Theme Downloaded! Refresh to see Changes'
                ...
                let websitePlugins =
                    JSON.parse(localStorage.getItem('websitePlugins')) || []
                websitePlugins.push(addonUrl)
                localStorage.setItem(
                    'websitePlugins',
                    JSON.stringify(websitePlugins),
                )
    ...
    uninstallButtons.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            if (addonType === 'themes') {
                ...
                let websitePlugins =
                    JSON.parse(localStorage.getItem('websitePlugins')) || []
                websitePlugins = websitePlugins.filter(
                    (pluginUrl) => pluginUrl !== addonUrl,
                )
                localStorage.setItem(
                    'websitePlugins',
                    JSON.stringify(websitePlugins),
...
document
    .getElementById('addon-category')
    .addEventListener('change', populateAddons)
document
    .getElementById('addon-search')
    .addEventListener('input', populateAddons)
populateAddons()
